 ...
 * }
 */
func TravelTree(root1 *cn.TreeNode, root2 *cn.TreeNode){
	...
	if root1 != nil && root2 != nil {
		...
		if root1.Left == nil && root2.Left != nil {
			root1.Left = &cn.TreeNode{0, nil, nil}
		}
		if root1.Right == nil && root2.Right != nil {
			root1.Right = &cn.TreeNode{0, nil, nil}
		}
	}
	if root2 != nil {
...
func mergeTrees(root1 *cn.TreeNode, root2 *cn.TreeNode) *cn.TreeNode {
	if root1 == nil {
		return root2
	}
